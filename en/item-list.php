        ...
        <div class="row mb-3">
            <div class="col-sm-12 col-md-6">
                <form action="/item-list.php" method="get">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-2">
                            <input type="submit" class="btn btn-primary p-2 mt-0" value="Search"/>
                        </div>
                    </div>
            ...
            <div class="col-sm-12 col-md-6">
                <select name="category" id="categorySelector" class="custom-select mb-3" style="width: 100%">
                    <option value="" <?= isset($_GET["category"]) ? "selected" : ""; ?>>All (<?= $view->getItemTotalCountListed(); ?>)</option>

                    <?php foreach($categories as $category) : ?>
                        <option value="<?= $category["cat_name_en"]; ?>" <?= @$_GET["category"] == $category["cat_name_en"] ? "selected" : ""; ?>>
                            <?= $category["cat_name_en"] . " (" . $view->getCategoryTotalCount($category["cat_name_en"]) . ")"; ?>
                        </option>
                    <?php endforeach; ?>
                ...
                <nav>
                    <ul class="pagination justify-content-center">
                        <li class="page-item <?= $page == 1 ? "disabled" : ""; ?>">
                            <a class="page-link" id="previous-page-button" <?= $page == 1 ? "tabindex='1' aria-disabled='true'" : ""; ?>>Previous</a>
                        </li>
                        ...
                        <li class="page-item<?= $page == $totalPage ? " disabled" : ""; ?>">
                            <a class="page-link" id="next-page-button" <?= $page == $totalPage ? "tabindex='1' aria-disabled='true'" : ""; ?>>Next</a>
                        </li>
                    </ul>
                </nav>
            </div>
