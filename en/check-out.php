...
if (isset($_POST["submit"])) {
    ...
    if($controller->insertNewOrder($order)){
        ...
        // Reset cart
        $cart->resetCart();
        UsefulFunction::generateAlert("Inventory has less amount of quantity for you! Please add to cart again!");
    ...
    <main class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-lg-8">
                <div class="h1">Check Out Page</div>
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-row mb-3 p-3">
                        <div class="col-12">
                            <div class="row mb-3">
                                ...
                                <div class="col-12"><label><strong>Please click your payment</strong></label></div>
                            ...
                            <div class="row text-center">
                                <div class="col-12"><span class="orange-text" style="font-size: 25px;"><strong>Please make sure you screenshot your receipt for uploading!</strong></span></div>
                            </div>
                        </div>
                    </div><!-- Make Payment -->
                    ...
                    <div class="form-group">
                        ...
                        <small id="nameHelp" class="form-text text-muted">We will use this name for shipping</small>
                    </div><!-- User name -->

                    <!-- Phone number -->
                    <div class="form-row mb-3">
                        <div class="col-12"><label>Contact Number</label></div>
                        <div style="width: 30%"><select class="form-control" name="c_phone_mcc" id="c-phone-mcc"></select></div>
                        <!--class="col-sm-8 col-md-5 col-lg-4"-->
                        <div style="width: 50%"><input type="text" class="form-control" name="c_phone" aria-describedby="phoneHelp" placeholder="Contact Number" required></div>
                        <div class="col-12"><small id="phoneHelp" class="form-text text-muted">Format: +60 12-1234 5678</small></div>
                    </div><!-- Phone number -->

                    <!-- Address (House Number and Street) -->
                    <div class="form-row mb-2">
                        <div class="col-12"><label>Shipping Address</label></div>
                        <div class="col-12 mb-1"><input type="text" name="c_address" class="form-control" placeholder="House number/Street" autocomplete="off" required /></div>
                        <div class="col mb-1" id="c-state"><input type="text" name="c_state" class="form-control" placeholder="State" autocomplete="off" required /></div>
                        <div class="col mb-1" id="c-area"><input type="text" name="c_area" class="form-control" placeholder="Area/City" disabled autocomplete="off" required /></div>
                        <div class="col mb-1" id="c-postal-code"><input type="text" name="c_postal_code" class="form-control" placeholder="Postal Code" disabled autocomplete="off" required /></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-file">
                            ...
                            <label class="custom-file-label" for="receipt" data-browse="上传">Please upload your receipt</label>
                            <small id="receiptHelp" class="form-text text-muted">Format support ".jpg", ".jpeg", ".gif", ".png"<br>Maximum 5MB</small>
                        </div>
                    </div><!-- Upload Receipt -->

                    <div class="text-center"><input class="btn btn-primary" type="submit" value="Submit Order" name="submit" style="width: 200px;" <?= empty($cart->getCartItems()) ? "disabled" : ""; ?>></div>
