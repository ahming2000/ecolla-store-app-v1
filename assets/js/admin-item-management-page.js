...
$(document).ready(function(){
    ...
    $("#extraProperty").on("click", function(){
        ...
        var newVarietyImageBox ='<div class="col-xs-6 col-sm-4 col-md-3 col-lg-2"><label><input type="file" name="variety[' + propertyCount + '][image]" class="image-file-selector" style="display:none;"/><img class="img-thumbnail image-preview" src="../assets/images/alt/image-upload-alt.jpg"/><div style="text-align: center;" class="variety-property-caption"></div></label></div>';
