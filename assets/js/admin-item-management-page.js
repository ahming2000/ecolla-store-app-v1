...
$(document).ready(function(){
    ...
    $("#extra-catogory-button").on("click", function(){
        var catogoryCount = $("#catogory-section div").length;

        let str = getExtraCatogoryHTML(catogoryCount);
        $("#catogory-section").append(str);
    });

    // Extra property
    $("#extraProperty").on("click", function(){
        var propertyCount = $(".variety-property-main").length;
