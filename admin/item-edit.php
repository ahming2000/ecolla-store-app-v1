                ...
                <div class="col-12">
                    ...
                    <div class="row mb-3 expireDateForm">
                        <div class="row mr-3">
                            ...
                            <div class="col"><input value="<?php echo $_i->getVarieties()[0]->getShelfLifeList()[0]->getExpireDate(); ?>" type="date" class="form-control" name="expireDate1" aria-describedby="expireDate1" required></div>
                        </div>
                        <div class="row mr-3">
                            <div class="col"><label for="inventory1">库存</label></div>
                            <div class="col"><input value="<?php echo $_i->getVarieties()[0]->getShelfLifeList()[0]->getInventory(); ?>" type="number" class="form-control" name="inventory1" aria-describedby="inventory1" required></div>
                        </div>
                    </div>
