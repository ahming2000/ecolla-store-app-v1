  ...
  <div class="p-4">
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-8">
            <ol class="list-group">
                <li class="list-group-item active" id="normalSelected">香辣味</li>
                <li class="list-group-item" id="spicySelected">黑椒味</li>
                <li class="list-group-item" id="bothSelected">山椒味</li>
                <li class="list-group-item" id="bothSelected">烧烤味</li>
                <li class="list-group-item" id="bothSelected">黑鸭味</li>
            </ol>
        </div>
